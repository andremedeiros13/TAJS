...
```shell
cd modulo04-tdd-bdd/aula01-tdd
npm ci --silent
```
...
Supondo que você está em `TAJS/modulo04-tdd-bdd/aula01-tdd` e já restaurou os pacotes seguindo os passos anteriores execute:
```shell
code ../
